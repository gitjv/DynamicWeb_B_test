...
function printIndiAncestors(idx)
{
	...
	// 		[{
	// 			// JV added union type to title
	// 			title: _('Parents') + ': ' + famLinked(fdx) + ' <small> ' + _('Union:') + ' ' + F(fdx, 'type') +'</small>',
	// 			text: printIndiParents(fdx, idx, jvalue) //has extra parameters JV
	// 		},
	// 		{
	// 			title: _('Siblings'),
...
// JV added idx,j params so can use them in here to find parent roles
{
	...
	else
	{
		...
		{
			html += _('Not in this family (it is another marriage/union of a parent)');
		}
		html += '</p>';
	}
	return(html);
